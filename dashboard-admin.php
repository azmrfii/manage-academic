                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="dropdown-toggle" dropdown-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Tables</a>
                                <ul class="nav-link drowdown-menu">
                                    <li><a href="#">Table Guru</a></li>
                        ...
                        <div class="d-none d-lg-block">
                            <a href="profile.php" class="bi-person custom-icon me-3"></a>
                        </div>
                    </div>
                </div>
            </nav>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-4">
                        ...
                        <ul class="social-icon">
                            ...
                            <li><a href="https://www.instagram.com/azmrfii/" class="social-icon-link bi-instagram"></a></li>
