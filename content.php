...
<section class="about section-padding">
    <div class="container">
        <div class="row">
            ...
            <section class="team section-padding">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="mb-5">Siswa <span>Berprestasi</span></h2>
                        </div>
                        <?php
                            $sql = mysqli_query($con, "SELECT nama FROM tb_siswa ORDER BY nama ASC");
                            while($data=mysqli_fetch_array($sql)){
                        ?>
                        <div class="col-lg-4 mb-4 col-12">  
                            <div class="team-thumb d-flex align-items-center">
                                <img src="images/siswa/org.jpeg" class="img-fluid custom-circle-image team-image me-4" alt="">
                                <div class="team-info">
                                    <h5 class="mb-0"><?php echo $data['nama']?></h5>
                                    <strong class="text-muted">Peringkat 1, 2022/2023</strong>
        ...
        <div class="modal fade" id="don" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <?php
                $sql = mysqli_query($con, "SELECT a.nis, a.nama, b.jurusan, c.kelas FROM tb_siswa AS a JOIN tb_jurusan AS b ON a.kd_siswa = b.kd_jurusan JOIN tb_kelas AS c ON a.kd_siswa = c.kd_kelas LIMIT 1");
                while($data = mysqli_fetch_array($sql)){
            ?>
                <div class="modal-content border-0">
                    <div class="modal-header flex-column">
                        <h3 class="modal-title" id="exampleModalLabel"><?php echo $data['nama']?></h3>

                        <h6 class="text-muted">XI - RPL</h6>

                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>

                    <div class="modal-body">
                        <h5 class="mb-4">Istiqomah dalam ikhtiar adalah cara terbaik untuk kehidupan</h5>

                        <div class="row mb-4">
                            <div class="col-lg-6 col-12">
                                <p>NISN : <?php echo $data['nis'] ?>
                                <br>Kelas : <?php echo $data['kelas'] ?>
                                <br>Jurusan : <?php echo $data['jurusan'] ?></p>    
                            </div>
                            <div class="col-lg-6 col-12">
